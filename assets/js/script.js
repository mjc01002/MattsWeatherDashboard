      ...
      fetch(apiCall2).then(function (response) {
        response.json().then(function (data) {
          ...
          for (i = 1; i < 6; i++) {
            ...
            document.getElementById(u).innerHTML = "Temp: ";
            ...
            document.getElementById(v).innerHTML = "Wind: ";
            ...
            document.getElementById(t).innerHTML = "Humidity: ";
